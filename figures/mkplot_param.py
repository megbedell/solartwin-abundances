...
ax1.errorbar(5680, 10.5, xerr=np.median(b['err_teff']), fmt='None', c='k', ecolor='k', elinewidth=3, capsize=5, capthick=3)
ax1.set_xlabel(r'$T_{\rm eff}$ (K)', fontsize=36)
...
ax2.errorbar(4.15, 16, xerr=np.median(b['err_logg']), fmt='None', c='k', ecolor='k', elinewidth=3, capsize=5, capthick=3)
ax2.set_xlabel(r'$\log g$', fontsize=36)
...
ax3.errorbar(-0.14, 8.5, xerr=np.median(b['err_feh']), fmt='None', c='k', ecolor='k', elinewidth=3, capsize=5, capthick=3)
ax3.set_xlabel(r'$\mathrm{[Fe/H]}$', fontsize=36)
...
ax4.errorbar(0.93, 13, xerr=np.median(b['err_vt']), fmt='None', c='k', ecolor='k', elinewidth=3, capsize=5, capthick=3)
ax4.set_xlabel(r'$v_t$ (km s$^{-1}$)', fontsize=36)

for ax in [ax1, ax2, ax3, ax4]:
    ax.tick_params(length=10., width=2, labelsize=26, which='major', pad=12)
