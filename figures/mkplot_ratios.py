...
ax3.errorbar(age[thin], mgsi[thin], yerr=mgsi_err[thin], xerr=age_err[thin], fmt='o',  c=c2, ecolor=c2, mec=c2, mfc=c2, markersize=8)
ax3.errorbar(age[thick], mgsi[thick], yerr=mgsi_err[thick], xerr=age_err[thick], fmt='^', c=c3, ecolor=c3, mec=c3, mfc=c3, markersize=8)
...
ax3.set_xlabel('Age (Gyr)', fontsize=fs)
ax3.set_ylabel('Mg/Si', fontsize=fs)
...
ax4.errorbar(par['feh'][:-1][thick], mgsi[thick], yerr=mgsi_err[thick], xerr=par['err_feh'][:-1][thick], fmt='^', c=c3, ecolor=c3, mec=c3, markersize=8)
ax4.annotate(r'$\odot$', xy=(0.0, mgsi_sun), horizontalalignment='center', verticalalignment='center', color=c4, fontsize=30, weight='bold')

ax4.set_xticks(np.arange(-0.1,0.18,0.1))
ax4.set_xticks(np.arange(-0.18,0.18,0.02), minor=True)
...
ax.errorbar(age[thick], co[thick], yerr=co_err[thick], xerr=age_err[thick], fmt='^', c=c3, ecolor=c3, mec=c3, markersize=8)
...
ax2.errorbar(feh[thick], co[thick], yerr=co_err[thick], xerr=feh_err[thick], fmt='^', c=c3, ecolor=c3, mec=c3, markersize=8)
